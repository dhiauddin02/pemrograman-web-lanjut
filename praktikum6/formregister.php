    ...
    <section class="container-fluid">
        ...
        <section class="row justify-content-center">
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="prosesregister.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="InputEmail" aria-describeby="emailHelp" placeholder="Masukkan email" name="email">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-footer mt-2">
                        <p> Sudah punya account? <a href="formlogin.php">Login</a></p>
                    </div>
                </form>
            </section>
        </section>
